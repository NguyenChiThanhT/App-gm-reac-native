...
import { Props, State } from '../../TimelineProfileContainer/View';
...
class ProfileDetail extends React.Component<Props, State> {
	constructor(props) {
		super(props);
		this.state = {};
	}
			...
			<Container>
				...
				<Content>
					<View style={{justifyContent: 'center', alignItems: 'center', backgroundColor: STYLE_REF.WHITE, paddingVertical: 30}}>
						<View>
							<Image source={ this.props.user.avatar } resizeMode={'contain'} />
						</View>
						<Gap height={15}/>
