...
const TabBarBottom = TabNavigator({
    ...
    tabBarComponent: props => {
        ...
        return (React.createElement(Footer, null,
            React.createElement(FooterAction, { actionText: 'ホーム', iconType: 'line', iconName: 'home', onPress: () => props.navigation.navigate('Home'), active: index == 0 }),
            React.createElement(FooterAction, { actionText: '投稿', iconType: 'line', iconName: 'pencil', onPress: () => props.navigation.navigate('Post'), active: index == 1 }),
            React.createElement(FooterAction, { actionText: '見つける', iconType: 'line', iconName: 'magnifier', onPress: () => props.navigation.navigate('Locate'), active: index == 2 }),
            React.createElement(FooterAction, { actionText: 'お気に入り', iconType: 'line', iconName: 'heart', onPress: () => props.navigation.navigate('Favorite'), active: index == 3 })));
    }
});
