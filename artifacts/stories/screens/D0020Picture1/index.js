...
import { DashedTitle, OptionLabel } from '../../../components/';
import styles from './styles';
class D0020Picture1 extends React.Component {
    render() {
            ...
            React.createElement(Content, { contentContainerStyle: styles.container },
                React.createElement(View, { style: styles.contextContainer },
                    React.createElement(View, null,
                        React.createElement(Thumbnail, { square: true, source: require('../../assets/images/64x64_thumbnail.png') })),
